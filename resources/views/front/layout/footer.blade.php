            ...
            <div class="row">
              ...
              <div class="col-sm-3">
                <div class="widget">
                  ...
                  <ul class="icon-list">
                    <li><a href="#">Pramuka - 7</a></li>
                    <li><a href="#">Paskibra - 3</a></li>
                    <li><a href="#">PMR - 12</a></li>
                    <li><a href="#">WJLRC - 8</a></li>
                    <li><a href="#">Kepal - 4</a></li>
                  </ul>
                </div>
              </div>
              <div class="col-sm-3">
        ...
        <footer class="footer bg-dark"  style="background-color: #5271ff; color: #fff">
          <div class="container">
            <div class="row">
              <div class="col-sm-6">
                <p class="copyright font-alt">&copy; 2024&nbsp;<a href="index.html">Extracurricular Manajemen</a>, All Rights Reserved</p>
              </div>
              <div class="col-sm-6">
